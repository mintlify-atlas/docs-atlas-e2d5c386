...
- **Missing required env vars** — `MCP_SECRET`, `TAILSCALE_API_KEY`, `GITHUB_TOKEN`, and `PROXY_ALLOWED_DOMAINS` must all be set. A missing variable causes startup to fail.
