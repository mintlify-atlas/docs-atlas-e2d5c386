...
<Steps>
  ...
  <Step title="Set the health check path">
    In the service settings, set the **Health Check Path** to `/health`. EasyPanel will poll this endpoint to determine whether the deployment succeeded and the service is healthy.
  </Step>
